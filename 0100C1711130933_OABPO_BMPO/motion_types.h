...
//typedef enum
//{
//	MOTION_WIRE_CCW = 0,			//counter clockwise
//	MOTION_WIRE_CW					//clockwise
...
typedef struct			//for path tracking all position is in unit of meter 
{
	...
	float oa_pre_dir_x;
	float oa_pre_dir_y;
	float oa_arc_center_x;
	float oa_arc_center_y;
	T_bool pre_dir_stored;
...
typedef struct
{
	...
	T_motion_wire_track_dir           track_dir;
