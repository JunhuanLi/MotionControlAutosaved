...
void rotate_angle(T_motion_tracker* obj, float angle, T_side rot_dir) //angle is in degree
{
	float											pi_out=0.0;
...
void rotate_vector(T_motion_tracker* obj, float vec_x, float vec_y, T_side rot_dir, float linear_vel) //angle is in degree
{
	//转角度测试相关参数
