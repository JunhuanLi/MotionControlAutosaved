...
void rotate_angle(T_motion_tracker* obj, float angle, T_side rot_dir); 
void rotate_vector(T_motion_tracker* obj, float vec_x, float vec_y, T_side rot_dir, float linear_vel);
