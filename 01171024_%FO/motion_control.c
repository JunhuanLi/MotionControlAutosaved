...
void heading_control(T_motion* motion, T_action g_action, T_params_act g_action_params)
{
	...
	//
	//linear velocity should be tuned according to the distance with obstacles or electromagnetic wire.
	//
}
...
float g_omega_max = 6.98; //maximum angluar velocity 3000/45(rpm) == 6.98(rad/s)
...
//	
	...
	omega_dr_leftWheel = 3600 * omega_leftWheel/g_omega_max; // dr == dutyratio
	omega_dr_rightWheel = 3600 * omega_rightWheel/g_omega_max;
	//Set Speed
