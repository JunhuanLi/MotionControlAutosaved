...
//		}
//		//mower_motion_circle(&motion, 0.2, 0.1);
//		else if(circle_cali == 1)
//		{
//			motion.tracker.line_vel = 0.08;
//			motion.tracker.angular_vel = 0.2;
//		}
//		else if(circle_cali == 3)
//		{
//			rt_kprintf("\r\n motion start!!!!!!!!!!!!!!11"); 
//			motion.tracker.line_vel = 0.08;
//			motion.tracker.angular_vel = 0.0;
//		}
			...
			else if(motion.motion_state == MOTION_STATE_P2P)
			{
				...
				else
				{
					...
					if(g_decision.action == DIR_DRIVE)
					{
						...
						motion.zigzag.state = T_MOTION_ZIGZAG_STATE_LINE; //20171104 for ljh(remote)
					}
